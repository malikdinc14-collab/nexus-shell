...
## [ ] Phase 1: Core Logic
- [ ] Create `core/workspace/workspace_manager.sh`.
...
- [ ] Modify `core/search/live_grep.sh` to use multi-path ripgrep.
- [ ] Modify `core/search/quick_find.sh` to use multi-path fd.

...
- [ ] Implement `core/ui/hud/telemetry_aggregator.sh`.

## [ ] Phase 2: Renderer implementation
- [ ] Create `core/ui/hud/renderer.sh` (Bash/ANSI or Python).
- [ ] Design the layout strip (Pulse | Workspace | Locality).

## [ ] Phase 3: Tmux Provisioning
- [ ] Implement `core/ui/hud/hud_window_manager.sh` to pin the status window.
